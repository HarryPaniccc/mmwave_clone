...
def main():
    ...
    chest_motion = filter_butter(depth_rs_ch.range_bins,"bandpass",(1,3.2),4,sample_period_rs)[0]
    compensated_chest_motion = filter_butter(depth_rs_ch.range_bins-depth_rs_hp.range_bins,"bandpass",(1,3.2),4,sample_period_rs)[0]
    ...
    plt.subplot(324)
    left_leg_motion = filter_butter(depth_rs_ll.range_bins,"bandpass",(1,3.2),4,sample_period_rs)[0]
    compensated_leg_motion = filter_butter(depth_rs_ll.range_bins-depth_rs_hp.range_bins,"bandpass",(1,3.2),4,sample_period_rs)[0]
    ...
    plt.subplot(326)
    hip_motion = filter_butter(depth_rs_hp.range_bins,"bandpass",(1,3.2),4,sample_period_rs)[0]
